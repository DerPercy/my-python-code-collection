...
from models.VideoUpload import VideoUpload
...
"""
  ...
  #args["description"] = 
  if not os.path.exists(argsWinner.file):
    exit("Please specify a valid file using the --file= parameter.")

  youtube = get_authenticated_service(argsWinner)
  try:
    print("Upload winner video")
    initialize_upload(youtube, argsWinner)
    print("Upload budget video")
    initialize_upload(youtube, argsBudget)
  except HttpError as e:
